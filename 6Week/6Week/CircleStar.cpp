...
void Update()
{
    while (!glfwWindowShouldClose(window))
    {
        ...
        //3. Scale은 1프레임당 0.01씩 최대 1.3배까지 늘어났다가 0.7배까지 줄어들도록 만드시오 (반복)
...
\
        ...
        transform.rotation = glm::mat3(
            glm::cos(glm::radians(turing)), -glm::sin(glm::radians(turing)), 0,
            glm::sin(glm::radians(turing)), glm::cos(glm::radians(turing)), 0,
            0, 0, 1
        );
